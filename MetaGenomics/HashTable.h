...
class HashTable{
	...
	public:
		...
		vector<UINT64> * getListOfReads(const string & subString); 			// Get the list of reads that contain subString as prefix or suffix.
		UINT64 hashFunction(const string & subString); 						// Hash function.
